    ...
    <!-- <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col-sm">
            <div class="card h-100 style=" display: flex;>
                <img src="images/cholula.jpeg" class="display: flex;">
                <div class="card-body">
        ...
        <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted">medium spicy</small>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm">
            <img src="images/cholula.jpeg"  width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy="3em"></text></svg>
        ...
        <div class="col">
          <div class="card shadow-sm">
          <img src="images/gringo-hot-sauce.jpg" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
...
Imported from the US, the Original Gringo Bandito Hot Sauce deserves a central place on your spice shelf.</p>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="images/marie-sharps-belizean-heat.jpg" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="images/hellfire-chocolate-cherry-hell.jpg"  width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="images/mad-dog-reaper-sriracha-sauce.jpg" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="images/hot-high-mango.jpg" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
